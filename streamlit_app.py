...
def generate_content(topic):
    ...
    senior_research_analyst = Agent(
        ...
        backstory="You're an expert research analyst with advanced web research skills. "
                    "You excel at finding, analyzing, and synthesizing information from the internet using search tools. "
                    "You're skilled at distinguishing reliable sources from unreliable ones, fact-checking, cross-referencing, "
                    "and identifying key patterns and insights. You provide well-organized research briefs with proper citations "
    ...
    content_writer = Agent(
        role="Content Writer",
        goal=f"Transform the research on {topic} into engaging and accessible content",
